...
public interface UsersApi {
     ...
     * Create new user
     *
     * @param X_HMAC_SIGNATURE Podpis HMAC SHA256 przekazywany jako plain text (required)
    ...
    default ResponseEntity<UserResponse> createUser(
        @NotNull @Parameter(name = "X-HMAC-SIGNATURE", description = "Podpis HMAC SHA256 przekazywany jako plain text", required = true, in = ParameterIn.HEADER) @RequestHeader(value = "X-HMAC-SIGNATURE", required = true) String X_HMAC_SIGNATURE,
     ...
     *
     * @param id  (required)
     * @param X_JWS_SIGNATURE Podpis JWS przekazywany w nagłówku (required)
     * @param body  (required)
     * @return Success (status code 200)
     *         or Bad request (status code 400)
     *         or Unauthorized (status code 401)
    ...
    default ResponseEntity<UserResponse> updateUser(
        @Parameter(name = "id", description = "", required = true, in = ParameterIn.PATH) @PathVariable("id") UUID id,
        @NotNull @Parameter(name = "X-JWS-SIGNATURE", description = "Podpis JWS przekazywany w nagłówku", required = true, in = ParameterIn.HEADER) @RequestHeader(value = "X-JWS-SIGNATURE", required = true) String X_JWS_SIGNATURE,
